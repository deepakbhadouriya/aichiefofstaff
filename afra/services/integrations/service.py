...
def _demo_connectors(tenant_id: str, profile_id: str) -> list[IntegrationView]:
    ...
    return [
        ...
        IntegrationView(
            ...
            tenant_id=tenant_id,
            profile_id=profile_id,
            product_name="Zoho Books SME Ledger",
            category="erp",
            mode="demo_seeded",
            status=erp.status,
            seeded_fallback=True,
        ...
        IntegrationView(
            ...
            tenant_id=tenant_id,
            profile_id=profile_id,
            product_name="Google Workspace Gmail",
...
def _live_connectors(tenant_id: str, profile_id: str) -> list[IntegrationView]:
    ...
    return [
        ...
        IntegrationView(
            ...
            tenant_id=tenant_id,
            profile_id=profile_id,
            product_name="TallyPrime or Zoho Books",
            category="erp",
            mode="live",
            status=erp.status,
            seeded_fallback=True,
        ...
        IntegrationView(
            ...
            tenant_id=tenant_id,
            profile_id=profile_id,
            product_name="Google Workspace or Microsoft 365",
            category="communications",
            mode="live",
            status=mailbox.status,
            seeded_fallback=True,
